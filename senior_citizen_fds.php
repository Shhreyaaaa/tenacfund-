...
$standardFDs = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Senior Citizen FDs' ORDER BY id DESC LIMIT 1"));
$productName = $standardFDs[0]['subsubcategory'];
?>
...
<main id="main">
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <h2>Senior Citizen FDs</h2>
      </div>
    </section>
    <!-- End Breadcrumbs -->

<?php $seniorCitizenFds=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Senior Citizen FDs' order by id desc"));?>
   <!-- ======= Senior Citizen FDs Section ======= -->
    ...
    </section><!-- End Senior Citizen FDs Section -->
