...
$PortfolioManagement = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Portfolio Management' ORDER BY id DESC LIMIT 1"));
$productName = $PortfolioManagement[0]['subcategory'];
?>
