...
$MedicalLoan = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Medical Loan' ORDER BY id DESC LIMIT 1"));
$productName = $MedicalLoan[0]['subsubcategory'];
?>
