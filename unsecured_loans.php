...
$unSecuredLoans = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Unsecured Loans' ORDER BY id DESC LIMIT 1"));
$productName = $unSecuredLoans[0]['subcategory'];
?>
...
<?php $unsecuredLoans=$db->fetchAssoc($db->fireQuery("select * from `subcategory` where `subcategory`='Unsecured Loans' order by id desc"));?>
   <!-- ======= Unsecured Loans Section ======= -->
    ...
    </section><!-- End Unsecured Loans Section -->
