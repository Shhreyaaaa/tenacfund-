...
$Debt = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Debt' ORDER BY id DESC LIMIT 1"));
$productName = $Debt[0]['subsubcategory'];
?>
...
<?php $debt=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Debt' order by id desc"));?>
   <!-- ======= Debt Section ======= -->
