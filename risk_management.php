...
$riskmanagement = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Risk Management' ORDER BY id DESC LIMIT 1"));
$productName = $riskmanagement[0]['subcategory'];
?>
