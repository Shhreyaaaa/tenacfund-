...
$Index = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Index' ORDER BY id DESC LIMIT 1"));
$productName = $Index[0]['subsubcategory'];
?>
...
<?php $index=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Index' order by id desc"));?>
   <!-- ======= Index Section ======= -->
