...
$FlexiLoans = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Flexi Loans' ORDER BY id DESC LIMIT 1"));
$productName = $FlexiLoans[0]['subcategory'];
?>
...
<?php $flexiLoans=$db->fetchAssoc($db->fireQuery("select * from `subcategory` where `subcategory`='Flexi Loans' order by id desc"));?>
   <!-- ======= Flexi Loans Section ======= -->
    ...
    </section><!-- End Flexi Loans Section -->
