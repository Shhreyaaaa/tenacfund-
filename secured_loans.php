...
$securedLoans = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Secured Loans' ORDER BY id DESC LIMIT 1"));
$productName = $securedLoans[0]['subcategory'];
?>
...
<main id="main">
  ...
  </section><!-- End Secured Loans Section -->
