...
$HomeLoans = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Home Loan' ORDER BY id DESC LIMIT 1"));
$productName = $HomeLoans[0]['subcategory'];
?>
...
<?php $homeLoans=$db->fetchAssoc($db->fireQuery("select * from `subcategory` where `subcategory`='Home Loan' order by id desc"));?>
   <!-- ======= Home Loans Section ======= -->
    ...
    </section><!-- End Home Loans Section -->
