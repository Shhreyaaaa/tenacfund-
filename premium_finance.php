...
$Premiumfinance = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Premium Finance' ORDER BY id DESC LIMIT 1"));
$productName = $Premiumfinance[0]['subsubcategory'];
?>
