...
$CarLoan = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Car Loan' ORDER BY id DESC LIMIT 1"));
$productName = $CarLoan[0]['subcategory'];
?>
...
<?php $carLoan=$db->fetchAssoc($db->fireQuery("select * from `subcategory` where `subcategory`='Car Loan' order by id desc"));?>
   <!-- ======= car loan Section ======= -->
