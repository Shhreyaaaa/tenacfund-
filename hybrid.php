...
$Hybrid = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Hybrid' ORDER BY id DESC LIMIT 1"));
$productName = $Hybrid[0]['subsubcategory'];
?>
...
<?php $hybrid=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Hybrid' order by id desc"));?>
   <!-- ======= Hybrid Section ======= -->
