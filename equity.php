...
$Equity = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Equity' ORDER BY id DESC LIMIT 1"));
$productName = $Equity[0]['subsubcategory'];
?>
<style>
.enquiry-box {
  max-width: 70%; 
...
<?php $equity=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Equity' order by id desc"));?>
   <!-- ======= Equity Section ======= -->
