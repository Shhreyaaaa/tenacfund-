...
// Fetch Balance Transfer data from `subcategory` table
$balanceTransfer = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Balance Transfer' ORDER BY id DESC LIMIT 1"));
$productName = $balanceTransfer[0]['subcategory'];
?>
...
<main id="main">
  ...
  </section><!-- End Balance Transfer Section -->
