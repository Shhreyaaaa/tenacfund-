...
$standardFDs = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Standard FDs' ORDER BY id DESC LIMIT 1"));
...
<?php $standardFds=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Standard FDs' order by id desc"));?>
   <!-- ======= gold Loans Section ======= -->
    ...
    </section><!-- End gold Loans Section -->
