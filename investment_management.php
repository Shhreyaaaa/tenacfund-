...
$InvManagement = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Investment Management' ORDER BY id DESC LIMIT 1"));
$productName = $InvManagement[0]['subcategory'];
?>
<style>
.enquiry-box {
  max-width: 70%; 
