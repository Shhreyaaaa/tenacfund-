...
$womenDeposits = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Women Deposits' ORDER BY id DESC LIMIT 1"));
$productName = $womenDeposits[0]['subsubcategory'];
?>
    ...
    <section class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>Women Deposits</li>
        </ol>
        <h2>Women Deposits</h2>
      </div>
    </section>
    <!-- End Breadcrumbs -->

<?php $Fds=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Women Deposits' order by id desc"));?>
   <!-- ======= Women Deposits FDs Section ======= -->
    ...
    </section><!-- End Women Deposits FDs Section -->
