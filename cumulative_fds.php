...
$CumuFDs = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subsubcategory` WHERE `subsubcategory`='Cumulative FDs' ORDER BY id DESC LIMIT 1"));
$productName = $CumuFDs[0]['subsubcategory'];
?>
    ...
    <section class="breadcrumbs">
      <div class="container">
        <ol>
          ...
          <li>Cumulative FDs</li>
        </ol>
        <h2>Cumulative FDs</h2>
      </div>
    </section>
    <!-- End Breadcrumbs -->

<?php $cumulativeFds=$db->fetchAssoc($db->fireQuery("select * from `subsubcategory` where `subsubcategory`='Cumulative FDs' order by id desc"));?>
   <!-- ======= Cumulative FDs Section ======= -->
    ...
    </section><!-- End Cumulative FDs Section -->
