...
$GoldLoan = $db->fetchAssoc($db->fireQuery("SELECT * FROM `subcategory` WHERE `subcategory`='Gold Loans' ORDER BY id DESC LIMIT 1"));
$productName = $GoldLoan[0]['subcategory'];
?>
...
<?php $goldLoans=$db->fetchAssoc($db->fireQuery("select * from `subcategory` where `subcategory`='Gold Loans' order by id desc"));?>
   <!-- ======= gold Loans Section ======= -->
